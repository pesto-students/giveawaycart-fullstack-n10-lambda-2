...
const ContactUs = () => {
    ...
    <div className="border-2">
      <header className="relative pb-24  max-w-7xl mx-auto bg-header opacity-70 bg-sky-800 sm:pb-32">
        
        

        <div className="relative   max-w-8xl mx-auto px-4 sm:max-w-3xl  sm:px-6 lg:max-w-7xl lg:px-8">
